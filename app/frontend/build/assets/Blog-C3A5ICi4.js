import{z as h,u as c,t as e,X as p,A as m}from"./index-Jg3dTQoW.js";import{S as g}from"./search-DfvuyHaY.js";import{C as y}from"./clock-BeJZ7AGL.js";const b=[{slug:"designing-real-time-collaborative-editors",title:"Designing Real-Time Collaborative Code Editors at Interview Scale",tag:"Engineering",date:"Feb 24, 2026",readTime:"8 min read",author:"Standor Team",excerpt:"Building a collaborative editor where two developers type simultaneously — with zero conflicts and sub-100ms propagation — requires more than WebSockets. Here is how Standor combines Monaco Editor, Yjs CRDTs, and Socket.io to make it work reliably at scale.",content:`A collaborative coding editor is deceptively hard to build correctly. Naive approaches — sending the entire document on every keystroke, or using last-write-wins — break down as soon as two users type at the same position simultaneously. Standor solves this with Conflict-Free Replicated Data Types (CRDTs) via Yjs, paired with Monaco Editor and a Socket.io persistence layer.
