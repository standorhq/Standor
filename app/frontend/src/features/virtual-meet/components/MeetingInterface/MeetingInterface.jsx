...
const MeetingInterface = ({
  ...
  setIsOwnVideo, setScreen, screen, isOwnVideo,
  message, show, players, screenShared, screenShareInfo,
}) => {
  ...
  return (
    <>
      ...
      {shouldShowScreenFull && (
        <ScreenFull screen={screen} screenStreamRef={screenStreamRef} name={getScreenSharerName()} />
      )}
    </>
  );
};
