  ...
  return (
    <div className="lg:col-span-1 grid grid-cols-1 gap-6">
      ...
      <motion.div
        ...
        animate="visible"
        whileHover={{ y: -3 }}
        className="card bg-base-100 border-2 border-primary/20 hover:border-primary/40"
      >
      ...
      <motion.div
        ...
        animate="visible"
        whileHover={{ y: -3 }}
        className="card bg-base-100 border-2 border-secondary/20 hover:border-secondary/40"
      >
        <div className="card-body">
          <div className="flex items-center justify-between mb-3">
