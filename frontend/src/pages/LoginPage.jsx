...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-base-100 flex">
      {/* Left panel - branding */}
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary/10 via-base-200 to-secondary/10 flex-col items-center justify-center p-12 relative overflow-hidden">
        ...
        >
          ...
          <h1 className="text-4xl font-black gradient-text mb-3">Standor</h1>
          <p className="text-base-content/60 text-lg">The professional coding interview platform</p>
          <div className="mt-8 space-y-3 text-left">
            {['Real-time collaborative editor', 'WebRTC video calls', 'AI code analysis', 'Automated email reports'].map((f) => (
              <div key={f} className="flex items-center gap-3 text-base-content/70">
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        ...
        >
          ...
          <p className="text-base-content/60 mb-8">Sign in to your account to continue</p>
          ...
          <div className="divider text-base-content/40 text-xs">OR CONTINUE WITH EMAIL</div>
